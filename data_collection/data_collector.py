"""
Contributors: Lei Li ...
Script to collect data from optimization process. 
Pre-requirment: need a trajectory file that includes all structures to be optimized
Script will read parameters from 'config.ini' file. It define parameters of calculators
i.e., vasp calculator
TODO:
  1. include more calculator into class 'calc_constructor'
  2. include module that generates high-energy structures
  3. make parameters for optimizer controlable to user
"""
import ConfigParser
